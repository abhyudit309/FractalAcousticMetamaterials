...
d5 = 0.10000 # thickness of air cavity
...
no_of_faces = len(mdb.models['Model-1'].parts['AirInsideCarpet'].faces)
for i in range(0,no_of_faces):
    if mdb.models['Model-1'].parts['AirInsideCarpet'].faces[i].getCentroid()[0] == (0.0,0.0,round(-2*d2-d3-d4,5)):
        face_index = i
        edge_index = mdb.models['Model-1'].parts['AirInsideCarpet'].faces[i].getEdges()[0]
mdb.models['Model-1'].ConstrainedSketch(gridSpacing=7.07, name='__profile__', 
    sheetSize=282.84, transform=
    ...
    sketchPlaneSide=SIDE1, 
    sketchUpEdge=mdb.models['Model-1'].parts['AirInsideCarpet'].edges[edge_index], 
    sketchOrientation=RIGHT, origin=(0.0, 0.0, round(-2*d2-d3-d4,5))))
mdb.models['Model-1'].parts['AirInsideCarpet'].projectReferencesOntoSketch(
    filter=COPLANAR_EDGES, sketch=
    mdb.models['Model-1'].sketches['__profile__'])
for i in range(0,data.shape[0]):
...
no_of_faces = len(mdb.models['Model-1'].parts['AirInsideCarpet'].faces)
for i in range(0,no_of_faces):
    if mdb.models['Model-1'].parts['AirInsideCarpet'].faces[i].getCentroid()[0] == (0.0,0.0,round(-3*d2-d3-d4,5)):
        face_index = i
        edge_index = mdb.models['Model-1'].parts['AirInsideCarpet'].faces[i].getEdges()[0]
mdb.models['Model-1'].ConstrainedSketch(gridSpacing=7.07, name='__profile__', 
    sheetSize=282.84, transform=
    ...
    sketchPlaneSide=SIDE1, 
    sketchUpEdge=mdb.models['Model-1'].parts['AirInsideCarpet'].edges[edge_index], 
    sketchOrientation=RIGHT, origin=(0.0, 0.0, round(-3*d2-d3-d4,5))))
mdb.models['Model-1'].parts['AirInsideCarpet'].projectReferencesOntoSketch(
    filter=COPLANAR_EDGES, sketch=
    mdb.models['Model-1'].sketches['__profile__'])
mdb.models['Model-1'].sketches['__profile__'].rectangle(point1=(-a/2, -a/2), point2=(a/2, a/2))
mdb.models['Model-1'].parts['AirInsideCarpet'].SolidExtrude(depth=d5, 
    flipExtrudeDirection=OFF, sketch=
    mdb.models['Model-1'].sketches['__profile__'], sketchOrientation=RIGHT, 
    sketchPlane=mdb.models['Model-1'].parts['AirInsideCarpet'].faces[face_index], 
    sketchPlaneSide=SIDE1, sketchUpEdge=
...
##
for i in range(0,no_of_faces):
    if mdb.models['Model-1'].parts['AirInsideCarpet'].faces[i].getCentroid()[0] == (0,0,round(-2*d2-d3-d4,5)):
        v5 = mdb.models['Model-1'].parts['AirInsideCarpet'].faces[i].getVertices()[0:3]   
mdb.models['Model-1'].parts['AirInsideCarpet'].PartitionCellByPlaneThreePoints(
    cells=
    mdb.models['Model-1'].parts['AirInsideCarpet'].cells.getSequenceFromMask((
    '[#1 ]', ), ), point1=
    mdb.models['Model-1'].parts['AirInsideCarpet'].vertices[v5[0]], point2=
    mdb.models['Model-1'].parts['AirInsideCarpet'].vertices[v5[1]], point3=
    mdb.models['Model-1'].parts['AirInsideCarpet'].vertices[v5[2]])
for i in range(0,no_of_faces):
    if mdb.models['Model-1'].parts['AirInsideCarpet'].faces[i].getCentroid()[0] == (0,0,round(-3*d2-d3-d4,5)):
        v6 = mdb.models['Model-1'].parts['AirInsideCarpet'].faces[i].getVertices()[0:3]   
mdb.models['Model-1'].parts['AirInsideCarpet'].PartitionCellByPlaneThreePoints(
    cells=
    mdb.models['Model-1'].parts['AirInsideCarpet'].cells.getSequenceFromMask((
    '[#1 ]', ), ), point1=
    mdb.models['Model-1'].parts['AirInsideCarpet'].vertices[v6[0]], point2=
    mdb.models['Model-1'].parts['AirInsideCarpet'].vertices[v6[1]], point3=
    mdb.models['Model-1'].parts['AirInsideCarpet'].vertices[v6[2]])
### making sets 
tol = 1e-10
